...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
           ...
           if(!isValidBranch(branch)) {
            JOptionPane.showMessageDialog(this, "Please enter a valid branch.");
            return;
           }
    ...
    private boolean isValidCourse(String course) {
        return course.equals("B.Tech") ||
               course.equals("M.Tech") ||
               course.equals("Bsc") ||
               course.equals("Msc") ||
               course.equals("BCA") ||
               course.equals("Bcom") ||
    ...
    private boolean isValidBranch(String branch) {
        String[] validBranches = {"Computer Science", "Electrical", "Mechanical", "Civil", "Chemical"};
